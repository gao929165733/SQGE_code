...
encoder_path = 'pretrain_models/bert-base-uncased'

# model settings 
model = "pa_crf"
distance_metric = "conv"  # [dot, cos, euclidean, conv]
sample_num = 5
...
# eval_step = 10
test_epoch = 3000
early_stop_interval = 50    # 如果超过一定验证次数指标没有提升，就早停以节约时间。默认值是5
